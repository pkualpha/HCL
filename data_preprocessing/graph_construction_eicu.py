...
def get_graph_raw(dataset, dataset_path, fold):
    ...
    # the node with fewest neighbours has 9 neighbours
    # 21047822 nonzero values, 1.25% of original fully connected adjacency matrix
    print(A.shape)
...
if __name__ == "__main__":
    construct_graph("eicu", dataset_path)
